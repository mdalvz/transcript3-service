...
var TranscriptTable = exports.TranscriptTable = /** @class */ (function (_super) {
    ...
    function TranscriptTable() {
        ...
        _this.STUDENT_GRADUATION_DATE = 'studentGraduationDate';
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.connection.schema.createTable(this.TABLE_NAME, function (table) {
                                ...
                                table.text(_this.STUDENT_GRADUATION_DATE);
                                ...
                                table.integer(_this.ARRANGE_BY_GRADE);
                                table.integer(_this.WEIGHTED_GPA);
    ...
    TranscriptTable.prototype.getTranscript = function (transcriptId) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
