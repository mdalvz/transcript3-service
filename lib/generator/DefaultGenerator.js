...
class DefaultGenerator extends BaseGenerator_1.BaseGenerator {
    ...
    generateCourseworkBySubject() {
        ...
        for (let subject of subjects) {
            ...
            container.appendChild(this.generateCourseworkHeaderCell(`${totalAttempted}`, true));
            container.appendChild(this.generateCourseworkHeaderCell(`${totalAwarded}`, true));
            ...
            for (let e of subjectClasses) {
                ...
                container.appendChild(this.generateCourseworkCell(`${e.attempted === 0 ? '' : e.attempted}`, true));
                container.appendChild(this.generateCourseworkCell(`${e.attempted === 0 ? '' : e.awarded}`, true));
            }
        }
        return container;
    }
