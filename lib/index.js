...
const GenerateTranscript_1 = require("./operation/GenerateTranscript");
const GetAccount_1 = require("./operation/GetAccount");
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        app.post(transcript3_model_1.GenerateTranscriptResource, GenerateTranscript_1.generateTranscriptHandler);
        app.post(transcript3_model_1.GetAccountResource, GetAccount_1.getAccountHandler);
