...
function updateTranscript(request, accountEmail) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, TranscriptTable_1.TranscriptTable.instance.getTranscript(request.transcript.transcriptId)];
                case 1:
                    record = _a.sent();
                    if (record.accountEmail !== accountEmail) {
                        throw new Error('Transcript is owned by another account');
                    }
                    result = __assign(__assign({}, request.transcript), { accountEmail: accountEmail });
                    return [4 /*yield*/, TranscriptTable_1.TranscriptTable.instance.updateTranscript(result)];
                case 2:
                    _a.sent();
